...
import com.craxiom.networksurvey.listeners.IGpsTestListener;
 ...
 */
public class GpsStatusFragment extends Fragment implements IGpsTestListener
{
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        mDateFormat = new SimpleDateFormat(DateFormat.is24HourFormat(getContext()) ? "HH:mm:ss" : "hh:mm:ss a", Locale.getDefault());
    }
                             ...
                             Bundle savedInstanceState)
    {
        ...
        mFlagUsa = mRes.getDrawable(R.drawable.ic_flag_usa, theme);
        mFlagRussia = mRes.getDrawable(R.drawable.ic_flag_russia, theme);
        mFlagJapan = mRes.getDrawable(R.drawable.ic_flag_japan, theme);
        mFlagChina = mRes.getDrawable(R.drawable.ic_flag_china, theme);
        mFlagIndia = mRes.getDrawable(R.drawable.ic_flag_india, theme);
        mFlagEU = mRes.getDrawable(R.drawable.ic_flag_european_union, theme);
        mFlagICAO = mRes.getDrawable(R.drawable.ic_flag_icao, theme);
        ...
        // FIXME GpsTestActivity.getInstance().addListener(this);
    ...
    {
        if (mFixTime == 0)// FIXME || (GpsTestActivity.getInstance() != null && !GpsTestActivity.getInstance().mStarted))
        {
    ...
    {
        super.onResume();
        // FIXME setStarted(GpsTestActivity.getInstance().mStarted);
