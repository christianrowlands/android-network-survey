...
/**
 * DialogFragment bridge that hosts the [FileMqttHelpDialog] composable. Use this to show
 * the File Logging / MQTT Streaming help dialog from Java Fragment code.
 */
class FileMqttHelpDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            ...
            setContent {
                NsTheme {
                    FileMqttHelpDialog(onDismissRequest = { dismissAllowingStateLoss() })
                }
            }
        }
    }
    ...
    companion object {
        const val TAG = "FileMqttHelpDialog"
    }
}
