...
fun WatchlistAddSheet(
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.watchlist_add_dialog_title),
            ...
            Text(
                text = stringResource(R.string.watchlist_match_by),
            ...
            Row(
                ...
                Button(
                    ...
                    Text(stringResource(R.string.watchlist_add_confirm))
                }
            }
        }
    }
